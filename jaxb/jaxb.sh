...
curl -o saml-schema-metadata-2.0.xsd http://docs.oasis-open.org/security/saml/v2.0/saml-schema-metadata-2.0.xsd
curl -o xmldsig-core-schema.xsd http://www.w3.org/TR/2002/REC-xmldsig-core-20020212/xmldsig-core-schema.xsd
curl -o xenc-schema.xsd http://www.w3.org/TR/2002/REC-xmlenc-core-20021210/xenc-schema.xsd
curl -o saml-schema-assertion-2.0.xsd https://docs.oasis-open.org/security/saml/v2.0/saml-schema-assertion-2.0.xsd
